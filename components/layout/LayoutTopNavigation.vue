...
<template>
  ...
  <nav
    class="hidden lg:flex space-x-4 items-center justify-center"
  ...
  >
    <div
      ...
      class="relative hover:bg-[#4c3829]"
    ...
    >
      <NuxtLink
        ...
        class="text-base font-medium text-secondary-100 p-2 inline-block"
        @click="
...
<style scoped>
nav .link-active {
  @apply text-secondary-100 bg-[#b68a69] bg-opacity-10;
}
</style>
